package com.shinemo.task.starter;

import com.shinemo.ace4j.protocol.Codec;
import com.shinemo.ace4j.spring.AaceConsumerBean;
import com.shinemo.ace4j.spring.AaceProviderBean;
...
import com.shinemo.task.ace.impl.TaskSchedulerWorkerImpl;
import com.shinemo.task.constant.TaskScheduleConstant;
import com.shinemo.task.properties.TaskSchedulerProperties;
...
public class TaskSchedulerAutoConfiguration {
    ...
    /**
     * @see com.shinemo.ace4j.server.AaceServiceHandler
     * @return
     */
